...
/**
 * @brief Code39 decoder flags value: don't require stop symbol - can lead to
 *        false results
 */
...
var BarcodeScanner = {
	...
	MWBinitDecoder : function() {
		...
		if (Ti.Platform.osname === "android") {
			...
			BarcodeScanner
					.MWBregisterCode(MWB_CODE_MASK_128, "username", "key");
			BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_AZTEC, "username",
					"key");
			BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_DM, "username", "key");
			BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_EANUPC, "username",
					"key");
			BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_QR, "username", "key");
			BarcodeScanner
					.MWBregisterCode(MWB_CODE_MASK_PDF, "username", "key");
			BarcodeScanner
					.MWBregisterCode(MWB_CODE_MASK_RSS, "username", "key");
			BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_CODABAR, "username",
					"key");
			BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_DOTCODE, "username",
					"key");
			BarcodeScanner.MWBregisterCode(MWB_CODE_MASK_11, "username", "key");
			BarcodeScanner
					.MWBregisterCode(MWB_CODE_MASK_MSI, "username", "key");
		...
		BarcodeScanner.MWBsetDirection(MWB_SCANDIRECTION_HORIZONTAL
				| MWB_SCANDIRECTION_VERTICAL);
		// Our sample app is configured by default to search all supported
		// barcodes...
		BarcodeScanner.MWBsetActiveCodes(MWB_CODE_MASK_25 | MWB_CODE_MASK_39
				| MWB_CODE_MASK_128 | MWB_CODE_MASK_AZTEC | MWB_CODE_MASK_DM
				| MWB_CODE_MASK_EANUPC | MWB_CODE_MASK_PDF | MWB_CODE_MASK_QR
				| MWB_CODE_MASK_93 | MWB_CODE_MASK_CODABAR | MWB_CODE_MASK_11
				| MWB_CODE_MASK_MSI | MWB_CODE_MASK_RSS);

		// set the scanning rectangle based on scan direction(format in pct: x,
		// y, width, height)
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_25, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_39, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_128, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_AZTEC,
				RECT_FULL_2D.left, RECT_FULL_2D.top, RECT_FULL_2D.width,
				RECT_FULL_2D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_DM, RECT_FULL_2D.left,
				RECT_FULL_2D.top, RECT_FULL_2D.width, RECT_FULL_2D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_EANUPC,
				RECT_FULL_1D.left, RECT_FULL_1D.top, RECT_FULL_1D.width,
				RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_PDF, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_QR, RECT_FULL_2D.left,
				RECT_FULL_2D.top, RECT_FULL_2D.width, RECT_FULL_2D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_RSS, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_93, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_CODABAR,
				RECT_FULL_1D.left, RECT_FULL_1D.top, RECT_FULL_1D.width,
				RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_DOTCODE,
				RECT_DOTCODE.left, RECT_DOTCODE.top, RECT_DOTCODE.width,
				RECT_DOTCODE.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_11, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_MSI, RECT_FULL_1D.left,
				RECT_FULL_1D.top, RECT_FULL_1D.width, RECT_FULL_1D.height);
		...
		// set the scanning rectangle based on scan direction(format in pct: x,
		// y, width, height)
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_25,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_39,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_128,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_AZTEC,
		// RECT_PORTRAIT_2D.left, RECT_PORTRAIT_2D.top, RECT_PORTRAIT_2D.width,
		// RECT_PORTRAIT_2D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_DM,
		// RECT_PORTRAIT_2D.left, RECT_PORTRAIT_2D.top, RECT_PORTRAIT_2D.width,
		// RECT_PORTRAIT_2D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_EANUPC,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_PDF,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_QR,
		// RECT_PORTRAIT_2D.left, RECT_PORTRAIT_2D.top, RECT_PORTRAIT_2D.width,
		// RECT_PORTRAIT_2D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_RSS,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_93,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_CODABAR,RECT_PORTRAIT_1D.left,
		// RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_DOTCODE,RECT_DOTCODE.left,
		// RECT_DOTCODE.top, RECT_DOTCODE.width, RECT_DOTCODE.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_11,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_MSI,
		// RECT_PORTRAIT_1D.left, RECT_PORTRAIT_1D.top, RECT_PORTRAIT_1D.width,
		// RECT_PORTRAIT_1D.height);
		...
		// y, width, height)
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_25,
		// RECT_LANDSCAPE_1D.left, RECT_LANDSCAPE_1D.top,
		// RECT_LANDSCAPE_1D.width, RECT_LANDSCAPE_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_39,
		// RECT_LANDSCAPE_1D.left, RECT_LANDSCAPE_1D.top,
		// RECT_LANDSCAPE_1D.width, RECT_LANDSCAPE_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_128,
		...
		// RECT_LANDSCAPE_1D.width, RECT_LANDSCAPE_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_AZTEC,
		// RECT_LANDSCAPE_2D.left, RECT_LANDSCAPE_2D.top,
		// RECT_LANDSCAPE_2D.width, RECT_LANDSCAPE_2D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_DM,
		// RECT_LANDSCAPE_2D.left, RECT_LANDSCAPE_2D.top,
		// RECT_LANDSCAPE_2D.width, RECT_LANDSCAPE_2D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_EANUPC,
		...
		// RECT_LANDSCAPE_1D.left, RECT_LANDSCAPE_1D.top,
		// RECT_LANDSCAPE_1D.width, RECT_LANDSCAPE_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_CODABAR,RECT_LANDSCAPE_1D.left,
		// RECT_LANDSCAPE_1D.top, RECT_LANDSCAPE_1D.width,
		// RECT_LANDSCAPE_1D.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_DOTCODE,RECT_DOTCODE.left,
		// RECT_DOTCODE.top, RECT_DOTCODE.width, RECT_DOTCODE.height);
		// BarcodeScanner.MWBsetScanningRect(MWB_CODE_MASK_11,
		// RECT_LANDSCAPE_1D.left, RECT_LANDSCAPE_1D.top,
		...
		BarcodeScanner.MWBsetMaxThreads(100);
		BarcodeScanner.MWBenableZoom(true);
		BarcodeScanner.MWBsetZoomLevels(200, 400, 0);
		// enable extended mode for code 39 and 93
		BarcodeScanner.MWBsetFlags(MWB_CODE_MASK_39,
				MWB_CFG_CODE39_EXTENDED_MODE);
		BarcodeScanner.MWBsetFlags(MWB_CODE_MASK_93,
				MWB_CFG_CODE93_EXTENDED_MODE);
	...
	MWBswitchFlash : function() {
		scanner.MWBswitchFlash();
	},
...
var startScanning = function() {
	...
	BarcodeScanner.MWBuseBlinkingLineOverlay(false);
					...
					if (result && result.code) {
						...
						if (closeCameraOnDetection) {
							...
							if (isTablet) {
								...
								// Android uses platform-specific properties to
								// create windows.
								// All other platforms follow a similar UI
								// pattern.
								if (osname === 'android') {
