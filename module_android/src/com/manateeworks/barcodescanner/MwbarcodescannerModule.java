...
public class MwbarcodescannerModule extends KrollModule {
    ...
    public void addOverlayView(@Kroll.argument(optional = true) HashMap args) {
        if (args.containsKey("overlay")) {
            OverlayView.overlayProxy = (TiViewProxy) args.get("overlay");
        } else {
            OverlayView.overlayProxy = null;
        }
    }
    ...
    //zoom action
    @Kroll.method
    public void MWBactZoom() {
        ScannerActivity.getInstance().toggleZoom();
    }

    @Kroll.method
    public void MWBswitchFlash() {
        ScannerActivity.getInstance().toggleFlash();
    }
