...
public class ScannerActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static ScannerActivity instance;
...
//            mainLayout.addView(buttonZoom);
            ...
            if (OverlayView.overlayProxy != null) {
                View overlayView = OverlayView.overlayProxy.getOrCreateView().getNativeView();
                overlayView.setLayoutParams(previewParams);
