...
-(void)startup
{
   ...
   /* MWB_registerCode(MWB_CODE_MASK_39,      "username", "key");
    ...
    //controller=[[MWScannerViewController alloc] initWithDelegate:self withOverlay: overlay];
...
- (void)addOverlayView:(id)args{
    ...
    if (overlayProxy != nil)
    {
        ...
        if (overlay != nil) {
            [MWScannerViewController addOverlayView: overlay];
        }
    }
}
